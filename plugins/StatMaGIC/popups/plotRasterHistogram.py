...
from qgis.PyQt.QtWidgets import QListWidget, QListWidgetItem, QMenu, QAction
...
from qgis.core import QgsRasterLayer, QgsProject, QgsVectorLayer, QgsProject, QgsMapLayerProxyModel, QgsGeometry, QgsPoint, QgsCoordinateTransform
